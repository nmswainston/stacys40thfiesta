        ...
        >
          <div className="max-w-6xl mx-auto px-4 py-3 sm:py-4 flex items-center justify-between gap-4">
            ...
            >
              ...
              <span className="sm:hidden">Stacy's 40th Fiesta</span>
            </NavLink>
      ...
      <footer className="py-6 sm:py-8 md:py-10 text-center text-sm opacity-70 text-ink border-t border-brand-200 mt-8 sm:mt-12" role="contentinfo">
        <div className="max-w-6xl mx-auto px-4">
          ...
          <p className="text-xs sm:text-sm">
            Made with ❤️ by <a href="https://www.consolelogic.net" target="_blank" rel="noopener noreferrer" className="text-brand-700 hover:text-brand-600 underline decoration-brand-400/70 hover:decoration-brand-400 transition-colors">Nick</a>
          </p>
        </div>
      </footer>
    </div>
